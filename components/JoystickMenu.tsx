...
const JoystickMenu: React.FC<JoystickMenuProps> = ({ onAction }) => {
  ...
  return (
    <>
      {/* Screen Dimmer - Rendered separately to avoid fixed-in-fixed z-index issues */}
      {isOpen && (
        <div 
          className="fixed inset-0 bg-slate-950/40 backdrop-blur-sm z-[550] animate-in fade-in duration-300 pointer-events-auto"
